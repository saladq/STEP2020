...
public final class FindMeetingQueryTest {
 ...
 @Test
  ...
  public void noMandatoryAttendees() {
    // Adding two optional attendees with gaps in schedule, should return time in between gaps.
    ...
    Collection<TimeRange> expected = Arrays.asList(TimeRange.fromStartEnd(TimeRange.START_OF_DAY, TIME_0800AM, false), 
        TimeRange.fromStartEnd(TIME_0830AM, TIME_1100AM, false), TimeRange.fromStartEnd(TIME_1130AM, TimeRange.END_OF_DAY, true));
  ...
  public void noMandatoryAttendees2() {
    // Adding two optional attendees with no gaps in schedule, should return no time is available.

    Collection<Event> events = Arrays.asList(
    new Event("Event 1", TimeRange.fromStartDuration(TimeRange.START_OF_DAY, TIME_1130AM), Arrays.asList(PERSON_A)),
    new Event("Event 2", TimeRange.fromStartDuration(TIME_1100AM, TimeRange.END_OF_DAY), Arrays.asList(PERSON_B)));
